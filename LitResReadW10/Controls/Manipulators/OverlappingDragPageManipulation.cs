...
namespace LitResReadW10.Controls.Manipulators
{
    public class OverlappingDragPageManipulation : DragManipulationBase
    {
        ...
        {            
            ...
            Storyboard.SetTargetProperty(da, new PropertyPath("X").ToString());
        ...
        {
            FlipDirection direction = e.Cumulative.Translation.X > 0 ? FlipDirection.Backward : FlipDirection.Forward;
